    ...
    vector<Ground>& grounds, vector<Wall>& walls, Background& background, Foreground& foreground, TileMap& map)
{
    ...
    w.rectangle.setPosition(2809.96f, 1924.f);
    walls.push_back(w);
    ...
    w.rectangle.setSize(Vector2f(50.f, 200.f));
    w.rectangle.setPosition(19366.f, 1304.f);
    walls.push_back(w);
    ...
    w.rectangle.setSize(Vector2f(50.f, 200.f));
    w.rectangle.setPosition(19804.f, 1924.f);
    walls.push_back(w);
    ...
    w.rectangle.setSize(Vector2f(50.f, 200.f));
    w.rectangle.setPosition(18753.1f, 1804.f);
    walls.push_back(w);
    ...
    w.rectangle.setPosition(20996.4f, 1204.f);
    walls.push_back(w);

    w.rectangle.setSize(Vector2f(50.f, 850.f));
    w.rectangle.setPosition(21288.5f, 1764.f);
    walls.push_back(w);
    ...
    player.sprite.setPosition(20.7f, 804.f);
